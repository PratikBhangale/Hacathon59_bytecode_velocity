package com.example.hacathonbeta.Services;
...
public class LocationService extends Service {
    ...
    private Task< DocumentSnapshot >  driverRef ;
        ...
        mfusedLocationProviderClient.requestLocationUpdates(mLocationRequestHighAccuracy, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if (location != null) {
                            ...
                            DriverLocationObject driverLocationObject= new DriverLocationObject(geoPoint);
                            saveUserLocation(driverLocationObject);
                        }
                    }
                },
                Looper.myLooper());
    ...
    private void saveUserLocation(final DriverLocationObject userLocation){
